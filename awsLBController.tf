...
module "aws_load_balancer_controller" {
  ...
  role_description = "IRSA for aws-load-balancer-controller, ${module.eks.cluster_name}"
  ...
  policy_description = "IAM Policy for AWS Load Balancer Controller, ${module.eks.cluster_name}"
